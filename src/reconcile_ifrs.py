...
Input files (in /Input folder):
  - File with "SAP_IFRS" in name → Sheet "Balances", headers in row 9
...
def main():
    ...
    sap_file = find_input_file(SAP_KEYWORD)
    gebos_file = find_input_file(GEBOS_KEYWORD)

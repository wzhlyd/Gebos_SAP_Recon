"""
UGB Reconciliation Report: SAP vs GEBOS
Compares balances from SAP (Balances sheet) and GEBOS (GEB_gesamt sheet)
...
GEBOS_AMOUNT = "GEBOS_saldo_eur_ugb"

# Mapping: GEBOS dim name → SAP dim name (for display alignment)
DIM_DISPLAY = [
    "SAP-Konto",
    "AccProd",
    "Counterparty",
